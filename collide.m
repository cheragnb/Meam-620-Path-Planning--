...
x_points( (points(:,1) <= map.xyz_lim(1,1)) | (points(:,1) >= map.xyz_lim(2,1))) = 0;
y_points( (points(:,2) <= map.xyz_lim(1,2)) | (points(:,2) >= map.xyz_lim(2,2))) = 0;
z_points( (points(:,3) <= map.xyz_lim(1,3)) | (points(:,3) >= map.xyz_lim(2,3))) = 0;
